...
- Alignment of trimmed *Microcebus* reads against the *Microcebus murinus* reference genome (Mmur 3.0; [Larsen et al. (2017), *BMC Biol.*](https://doi.org/10.1186/s12915-017-0439-6)) with [BWA-MEM v0.7.17](https://github.com/lh3/bwa) and subsequent filtering of BAM files with [SAMtools v1.11](http://www.htslib.org/)
